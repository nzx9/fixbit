...
/*  This file is used for issue requesting API calls, 
    Method   : POST
    request  : pid, token and uid are required
    response : all issues matched to pid
*/
...
if (
    ...
    echo json_encode(array("success" => true, "data" => $issue->getAll()));
} else {
    http_response_code(200);
